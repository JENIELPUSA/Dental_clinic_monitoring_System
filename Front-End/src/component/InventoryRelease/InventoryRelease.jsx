...
import ExportPdfModal from "./releaseHistoryPDF";
...
const InventoryRelease = () => {
    const { releaseItems, fetchReleaseItems, addReleaseItem, TotalRelease, isTotalPages, currentPage, setCurrentPage, loading,fetchReleaseReportPDF } =
...
const [exportPeriod, setExportPeriod] = useState("");
  ...
  if (exportPeriod) {
    // Gamitin ang period filter
    fetchReleaseReportPDF({ period: exportPeriod });
  } else {
    // Gamitin ang custom date range
                ...
                {isMobile ? (
                    ...
                    <div className="space-y-3">
                        {loading ? (
                            ...
                            <div className="py-6 text-center text-sm text-gray-500 dark:text-gray-400">Walang nakitang release history.</div>
                        )}
                    </div>
                ) : (
                    /* Desktop: Table View */
                    ...
                    <div className="mt-4 flex flex-col items-center justify-between gap-2 text-xs text-gray-700 dark:text-gray-300 sm:flex-row sm:text-sm">
                        ...
                        <div className="flex flex-wrap justify-center gap-1">
                            <button
                                ...
                                className="rounded border px-2 py-1 hover:bg-gray-100 disabled:cursor-not-allowed disabled:opacity-50 dark:border-gray-600 dark:hover:bg-gray-700 sm:px-3 sm:py-1"
                            >
                                «
                            </button>
                            <button
