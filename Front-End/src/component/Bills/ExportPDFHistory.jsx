...
const ExportPdfModal = ({ isOpen, onClose, onGenerate, exportDates, setExportDates, exportStatus, setExportStatus }) => {
    if (!isOpen) return null;

    return (
        <div className="fixed inset-0 z-[999] flex items-center justify-center bg-black/50 p-4">
            <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-lg dark:bg-blue-900 dark:text-white">
                <h3 className="mb-4 text-lg font-bold text-blue-700 dark:text-blue-200">Export Payment History Report</h3>
