...
export default function AuthFormModal({ isOpen, onClose }) {
    ...
    const RoleSelectionStep = useCallback(() => (
        <div className="space-y-8">
            <div className="flex items-center justify-between">
                ...
                <h3 className="text-lg font-semibold text-blue-800">Select Your Role</h3>
            ...
            <div className="flex justify-center">
                <motion.button
                    ...
                    className="flex w-64 flex-col items-center rounded-xl border-2 border-blue-200 p-6 transition-colors hover:bg-blue-50"
                ...
                >
                    ...
                    <h4 className="text-base font-semibold text-blue-800">Patient</h4>
                    <p className="mt-2 text-center text-sm text-blue-600">Book appointments and manage your dental care</p>
                </motion.button>
            </div>
        </div>
    ), [handleRoleSelect]);
    ...
    return (
        <div className="fixed inset-0 z-[999] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 overflow-auto">
            <div className="relative w-full max-w-md">
                <AnimatePresence mode="wait">
                    {!isFlipped ? (
                        <motion.div
                            key="login"
                            className="rounded-xl border border-blue-100 bg-white p-8 shadow-lg relative"
                            initial="hidden"
                            animate="visible"
                            exit="exit"
                        ...
                        >
                            ...
                            <div className="mb-8 flex flex-col items-center">
                                ...
                                <h2 className="text-center text-2xl font-bold text-blue-800">DENTAL CARE</h2>
                                <p className="mt-1 text-sm text-blue-600">Clinic Monitoring System</p>
                            </div>

                            <form className="space-y-5" onSubmit={handleLoginSubmit}>
                                <div>
                                    <label htmlFor="email" className="mb-2 block text-sm font-medium text-blue-700">Email Address</label>
                                    <input
                                        type="email"
                                        id="email"
                                        name="email"
                                        ...
                                        disabled={isLoading}
                                        className="w-full rounded-lg border border-blue-200 bg-blue-50 px-4 py-2 focus:border-transparent focus:ring-2 focus:ring-blue-500 disabled:opacity-50"
                                ...
                                <div>
                                    <label htmlFor="password" className="mb-2 block text-sm font-medium text-blue-700">Password</label>
                                    <input
                                        type="password"
                                        id="password"
                                        name="password"
                                ...
                                <button
                                    type="submit"
                                    className={`flex w-full items-center justify-center gap-2 ${isLoading ? "cursor-not-allowed bg-blue-400" : "bg-blue-600 hover:bg-blue-700"} rounded-lg px-4 py-2 font-medium text-white shadow-md transition-colors duration-200`}
                                    disabled={isLoading}
                                >
