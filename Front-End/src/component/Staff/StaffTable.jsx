      ...
      <div className="md:hidden space-y-4">
        {loading ? (
          ...
          isStaff.map((data) => (
            <div
              key={data._id}
              className="rounded-lg border border-blue-100 bg-white p-4 shadow-sm dark:border-blue-800/30 dark:bg-blue-900/20 relative"
            >
              {/* Avatar & Name */}
              ...
              <div className="text-sm text-gray-700 dark:text-gray-300 mb-3 space-y-1">
                ...
                <div>
                  <span className="font-medium">Contact:</span> {data.contact_number || "N/A"}
                </div>
              </div>
              ...
              <div className="absolute top-3 right-3">
                <button
                  onClick={() => handleEditClick(data)}
                  className="p-1.5 text-blue-500 hover:bg-blue-100 rounded-full dark:text-blue-300 dark:hover:bg-blue-800/30"
                  title="Edit Staff"
                >
