...
const SkeletonCard = () => (
  <div className="animate-pulse rounded-lg border border-blue-200 bg-white p-3 shadow dark:border-blue-800/50 dark:bg-blue-900/20">
    ...
    <div className="mt-2 space-y-2">
      {[...Array(5)].map((_, i) => (
        <div key={i} className="h-3.5 w-full rounded bg-blue-100 dark:bg-blue-800/40"></div>
      ))}
    </div>
  </div>
);
        ...
        <div className="mt-4 flex flex-col items-center justify-between gap-2 text-xs text-blue-800 dark:text-blue-200 sm:flex-row sm:text-sm">
          ...
          <div className="flex flex-wrap justify-center gap-1">
            <button
              ...
              className="rounded border px-2 py-1 disabled:cursor-not-allowed disabled:opacity-50 hover:bg-blue-100 dark:hover:bg-blue-800/20"
            >
              «
            </button>
            <button
