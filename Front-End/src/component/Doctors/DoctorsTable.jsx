            ...
            >
              ...
              <div className="flex items-start gap-3 mb-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">{dr.specialty || "N/A"}</p>
                </div>
              </div>

              {/* Email & Date */}
              <div className="text-sm text-gray-700 dark:text-gray-300 mb-3">
                <p className="font-medium">{dr.email || "N/A"}</p>
                <p className="text-xs text-gray-500 dark:text-gray-400">Joined: {formatDate(dr.created_at)}</p>
              </div>

              {/* Actions */}
              <div className="flex justify-center gap-2 pt-2 border-t border-blue-100 dark:border-blue-800/30">
                {role !== "staff" && (
                  <button
                    onClick={() => onDoctortSelect(dr)}
                    className="p-2 text-blue-500 hover:bg-blue-100 rounded-full dark:text-blue-300 dark:hover:bg-blue-800/30"
                    title="Edit"
                  >
                ...
                {dr.scheduled !== true && (
                  <button
                    onClick={() => onAddSchedule(dr._id)}
                    className="p-2 text-red-500 hover:bg-red-100 rounded-full dark:text-red-300 dark:hover:bg-red-800/30"
                    title="Add Schedule"
                  >
      ...
      {!loading && isTotalPages > 1 && (
        <div className="mt-4 flex flex-col items-center justify-between gap-3 sm:flex-row">
          ...
          <div className="flex flex-wrap justify-center gap-1">
            ...
            <button className="rounded border bg-blue-100 px-2 py-1 text-sm font-bold text-blue-800 dark:bg-blue-800/50 dark:text-blue-200">
              {currentPage}
            </button>
