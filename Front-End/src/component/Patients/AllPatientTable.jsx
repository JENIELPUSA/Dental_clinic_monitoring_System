    ...
    const filteredPatients =
        patients?.filter((patient) => {
            ...
            return (
                ...
                patient.emergency_contact_number?.includes(searchTerm)
            );
        }) || [];
                ...
                <table className="w-full border border-blue-200 text-sm dark:border-blue-800/50">
                    <thead>
                        <tr className="bg-blue-50 text-left dark:bg-blue-900/30">
                            ...
                            <th className="border px-3 py-2 text-blue-800 dark:border-blue-800/50 dark:text-blue-200">PatientID</th>
