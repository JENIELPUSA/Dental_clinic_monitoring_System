  ...
  try {
    ...
    const transporter = nodemailer.createTransport({
      ...
      auth: {
        ...
        pass: process.env.EMAIL_PASSWORD, // dapat App Password kung 2FA ang Gmail
      },
    });
    ...
    const mailOptions = {
      ...
      <head>
        ...
        <style>
          ...
          .dental-icon { font-size:36px; margin-top:15px; display:inline-block;}
          ...
          @media (max-width:600px){ .content { padding:30px 20px;} .greeting { font-size:22px; } }
        </style>
      </head>
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <div class="message">${options.text}</div>
            <div class="info-card">
    ...
    // Optional: throw original error for upstream handling
